...
RUN chown -R 1001:1001 /var/www /var/run/httpd /var/log/httpd /etc/httpd /etc/httpd/logs/
RUN chmod -R g+rw /var/www /var/run/httpd /var/log/httpd /etc/httpd /etc/httpd/logs/
...
RUN echo '<html><body><h1>Apache on OpenShift</h1></body></html>' > /var/www/html/index.html && \
    chown apache1:apache1 /var/www/html/index.html
